...
func TestGet(t *testing.T) {
	...
	data := "..."
	if x, err := DefaultGoProxy.GoGet(url); x == nil || err != nil {
...
func TestFilterGet(t *testing.T) {
	...
	if x := DefaultGoProxy.GoGetAndFilter(url, filter, false); string(x) != data  {
...
func TestHateoasExpand(t *testing.T) {
	...
	if x, err := DefaultGoProxy.HateoasExpand(input, expand); string(x) != data  || err != nil {
...
func TestAssault(t *testing.T) {
	...
	if !DefaultGoProxy.Assault(req, 2, 3) {
